...
struct TriangleTests {
    @Test func triangleProperties() {
        let p1 = Point(x: 0, y: 0)
        let p2 = Point(x: 3, y: 0)
        let p3 = Point(x: 0, y: 4)
        let triangle = Triangle(p1: p1, p2: p2, p3: p3)
    ...
    @Test func triangleEquality() {
        let t1 = Triangle(p1: Point(x: 0, y: 0), p2: Point(x: 1, y: 0), p3: Point(x: 0, y: 1))
        let t2 = Triangle(p1: Point(x: 1, y: 0), p2: Point(x: 0, y: 1), p3: Point(x: 0, y: 0))
        let t3 = Triangle(p1: Point(x: 0, y: 0), p2: Point(x: 2, y: 0), p3: Point(x: 0, y: 1))
        
        #expect(t1 == t2) // Same triangle with different point order
        #expect(t1 != t3) // Different triangle
    }
    
    @Test func triangleHashing() {
        let t1 = Triangle(p1: Point(x: 0, y: 0), p2: Point(x: 1, y: 0), p3: Point(x: 0, y: 1))
        let t2 = Triangle(p1: Point(x: 1, y: 0), p2: Point(x: 0, y: 1), p3: Point(x: 0, y: 0))
